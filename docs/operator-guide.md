# Switchboard operator guide

This is the complete configuration and deployment reference. For the concise
project overview and quick start, see the [main README](../README.md).
...
[Pocket ID OAuth setup](pocket-id.md) for the rollout checklist.
...
[Dynamic MCP discovery](dynamic-mcp.md). The design keeps Switchboard as
...
in [Pocket ID OAuth setup](pocket-id.md#client-setup). Do not combine an
...
See [review archives](releases.md) for reproducible Linux gateway builds,
